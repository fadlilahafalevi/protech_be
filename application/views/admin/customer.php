            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-2 col-12">
                  <!-- <a class="btn btn-primary btn-sm" style="margin-bottom: 20px;" href="/protechapp/index.php/Controller_Customer/createCustomer">Tambah</a>  -->
                  <a class="btn btn-primary btn-sm float-right" style="margin-bottom: 20px;" href="/protechapp/index.php/Controller_Customer/printCustomer">Cetak</a>
                </div>
              </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?=$list_customer->last_login_datetime?></td>
                        <td style="text-align: center">
                          <?php
                            if($list_customer->up_active_status == '1'){
                          ?>
                            <label class="badge badge-success">Aktif</label>
                          <?php
                            } elseif($list_customer->up_active_status == '0'){
                          ?>
                        ...
                        <td style="text-align: center">
                          <a class="btn btn-primary" href="/protechapp/index.php/Controller_Customer/getOne/<?=$list_customer->user_code?>" data-toggle="tooltip" title="Lihat" style="padding: 4px">
                            <i class="mdi mdi-eye"></i>
                          </a>
                          <a class="btn btn-primary" href="/protechapp/index.php/Controller_Customer/updateCustomer/<?=$list_customer->user_code?>" data-toggle="tooltip" title="Ubah" style="padding: 4px">
