                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="text-align: center">
                          <a class="btn btn-primary" href="/teknisi-app/index.php/Controller_Customer/getOne/<?=$list_customer->user_code?>" data-toggle="tooltip" title="Lihat" style="padding: 4px">
                            <i class="mdi mdi-eye"></i>
                          </a>
                          <a class="btn btn-primary" href="/teknisi-app/index.php/Controller_Customer/updateCustomer/<?=$list_customer->user_code?>" data-toggle="tooltip" title="Ubah" style="padding: 4px">
