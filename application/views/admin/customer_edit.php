                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea class="form-control" rows="4" cols="50" id="address" name="address" required readonly="readonly"><?=$customer_detail->address?></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
...
function initialize() {
    var latlng = new google.maps.LatLng(<?php echo $data[0]->latitude ?>, <?php echo $data[0]->longitude ?>);
