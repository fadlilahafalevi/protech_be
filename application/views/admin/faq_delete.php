  ...
  <div class="main-panel">
    <div class="content-wrapper pb-0">
      <div class="page-header">
        <h3 class="page-title">Delete FAQ</h3>
      </div>
          ...
          <div class="card">
            <div class="card-body">
               <h4 class="card-title"></h4>
                     ...
                     ?>
                    <form class="forms-sample" method="post" action="<?php echo base_url() . 'Controller_FAQ/deleteData'; ?>">
                        <div class="form-group row" hidden>
                           <label class="col-sm-3 col-form-label" for="id">ID</label>
                           <div class="col-sm-9">
                              <input type="text" class="form-control" id="id" name="id" readonly="readonly" value="<?=$faq_detail->id?>">
                           </div>
                        </div>
