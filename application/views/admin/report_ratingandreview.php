            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-2 col-12">
                  ...
                  <a class="btn btn-primary btn-sm float-right" style="margin-bottom: 20px;" href="/protechapp/index.php/Controller_ReportRatingAndReview/printReportRatingAndReview">Cetak</a>
                </div>
              </div>
