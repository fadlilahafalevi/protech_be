            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-10 col-12">
                  <h4 class="card-title">Laporan Penilaian dan Ulasan</h4>
                </div>
                <form class="form-inline justify-content-center" method="post" action="<?php echo base_url() . 'Controller_ReportRatingAndReview'; ?>" enctype="multipart/form-data">
                <!-- <form class="form-inline justify-content-center"> -->
                  ...
                  &nbsp;
                  <a class="btn btn-primary btn-sm float-right" href="/protechapp/index.php/Controller_ReportRatingAndReview/printReportRatingAndReview/<?=$from_date?>/<?=$to_date?>">Cetak</a>
                </form>
              </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?=$list_report->rate?></td>
                        <td><?=$list_report->review?></td>
                      </tr>
                    <?php
                      }
                    ?>    
