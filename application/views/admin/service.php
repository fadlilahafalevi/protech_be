                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                              ...
                              <td>
                                 <a class="btn btn-warning" href="/Protech_BE/index.php/Controller_User/updateUser/<?=$list_service->id?>" data-toggle="tooltip" title="Edit" style="padding: 4px">
                                  <i class="mdi mdi-pencil-box-outline"></i>
                                </a>
                                <?php
                                  if($list_service->active_status == '1'){
                                ?>
                                  <a class="btn btn-danger" href="/Protech_BE/index.php/Controller_User/inactivateUser/<?=$list_service->id?>" data-toggle="tooltip" title="Inactive" style="padding: 4px">
                                    <i class="mdi mdi-account-remove"></i>
                                  </a>
                                <?php
                                  } elseif($list_service->active_status == '0'){ 
                                ?>
                                  <a class="btn btn-primary" href="/Protech_BE/index.php/Controller_User/activateUser/<?=$list_service->id?>" data-toggle="tooltip" title="Activate" style="padding: 4px">
