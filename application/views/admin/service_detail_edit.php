               ...
               <h4 class="card-title"></h4>
                    ...
                    <form class="forms-sample" method="post" action="<?php echo base_url() . 'Controller_Service/updateDataDetail'; ?>">
                        <div class="form-group row">
                           ...
                           <div class="col-sm-9">
                              <input type="text" class="form-control" id="service_detail_code" name="service_detail_code" value="<?=$service_detail->service_detail_code?>" readonly>
                           </div>
                        </div>
                        ...
                        <a class="btn btn-light" href="/protech/index.php/Controller_Service/getAllServiceDetailByCategory/<?=$service_detail->service_category_code?>">Back</button>
                     </form>
                     <?php
                        }
                     ?>
