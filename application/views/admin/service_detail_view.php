                           ...
                           <form id="edit-profile" class="form-horizontal">
                              <fieldset>
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <input type="text" class="span3" id="service_detail_code" name="service_detail_code" value="<?=$service_detail->service_detail_code?>" disabled="disabled">
                                    </div>
                                    <!-- /controls -->       
                                 </div>
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <input type="text" class="span3" id="service_detail_name" name="service_detail_name" value="<?=$service_detail->service_detail_name?>" disabled="disabled">
                                    </div>
                                    <!-- /controls -->       
                                 </div>
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <input type="text" class="span3" id="price" name="price" value="<?=$service_detail->price?>" disabled="disabled">
                                    </div>
                                    <!-- /controls -->       
                                 </div>
                                 <div class="control-group">
