    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Cari Data Jenis Layanan</h4>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-2 col-12">
                  <a class="btn btn-primary btn-sm float-right" style="margin-bottom: 20px;" href="/teknisi-app/index.php/Controller_ServiceType/createServiceType">Tambah</a> 
