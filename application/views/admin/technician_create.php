                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="account_number_gopay" name="account_number_gopay" required/>
                            </div>
                          </div>
                        </div>
                    </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><input type="checkbox" name="<?=$list_service_type->service_type_code?>" value="<?=$list_service_type->service_type_code?>" > <?=$list_service_type->service_type_name?></td>
                          </tr>
                        <?php
                          }
                        ?>    
