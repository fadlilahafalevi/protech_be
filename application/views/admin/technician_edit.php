...
<!-- first row starts here -->
  <div class="main-panel">
    <div class="content-wrapper">
      <?php
        foreach ($technician_data as $technician_detail) {
      ?>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea class="form-control" rows="4" cols="50" id="address" name="address" required readonly="readonly"><?=$technician_detail->address?></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
...
function initialize() {
    var latlng = new google.maps.LatLng(<?php echo $technician_data[0]->latitude ?>, <?php echo $technician_data[0]->longitude ?>);
...
function populateDates(){
  ...
  var daySelected = <?php echo $technician_data[0]->d_dob ?>,
      monthSelected = <?php echo $technician_data[0]->m_dob ?>,
      yearSelected = <?php echo $technician_data[0]->y_dob ?>;
