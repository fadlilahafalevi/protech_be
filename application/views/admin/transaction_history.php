    ...
    <div class="content-wrapper pb-0">
      <div class="page-header">
        ...
        <div class="template-demo">
          <a class="btn btn-primary" href="/protech/index.php/Controller_Wallet/downloadTransactionHistory/<?=$from?>/<?=$to?>">Download</a>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
            <form class="forms-sample" method="post" action="<?php echo base_url() . 'Controller_Wallet/transactionHistory'; ?>">
