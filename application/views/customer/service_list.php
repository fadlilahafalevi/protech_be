                    ...
                    <div class="dropdown-menu show" aria-labelledby="dropdownMenuOutlineButton1">
                        <?php 
                          foreach ($list_service_category->subs as $list_service_detail){
                            ...
                            {
                        ?>
                          <a class="dropdown-item" href="/protech/index.php/Controller_Order/createOrder/<?=$list_service_detail->service_detail_code?>"><?=$list_service_detail->service_detail_name?> <i class="mdi mdi-code-greater-than float-right"></i></a>
                        <?php } } ?>
                    </div>
                  </div>
                </div>
